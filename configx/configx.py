...
class ConfigX(object):
    ...
    def __init__(self):
        ...
        # Dataset Parameters
        self.dataset_name = "ep"  # short name of datasets ["ft":"filmtrust","db":"douban","ca":"ciao", "ep":"epinions"]
        ...
        self.min_val = 1.0  # the minimum rating value 0.5(ft)
        self.max_val = 5.0  # the maximum rating value 4.O(ft)
